...
<CardGroup cols={2}>
  ...
  >
    Learn more about the different subscription plans and their included agents.
  </Card>
  <Card
    title="Purchase Agents"
    icon="shopping-cart"
    href="/docs/purchase-agents"
  >
    Detailed guide on how to purchase additional agents.
  </Card>
</CardGroup>

## Conclusion

Effectively managing agents in NLPearl.AI ensures that your inbound and outbound call activities run smoothly, with the capacity to handle the required call volume. By understanding and utilizing agent management features, you can optimize your operations and improve overall efficiency.
