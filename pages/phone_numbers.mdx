...
<CardGroup cols={2}>
  ...
  >
    Learn more about the different subscription plans and their included phone numbers.
  </Card>
  <Card
    title="Purchase Phone Numbers"
    icon="phone"
    href="/docs/purchase-phone-numbers"
  >
    Detailed guide on how to purchase and manage phone numbers.
  </Card>
</CardGroup>

## Conclusion

Managing phone numbers effectively in NLPearl.AI is crucial for optimizing your inbound and outbound call activities. By understanding the purchasing process, pricing, and usage guidelines, you can ensure your operations run smoothly and efficiently.
